...
一个使用 **Claude Code** + **GLM-4.7** 开发的现代化 CRM 系统。从 2024 年 9 月开始，经历了五次重构，最终选择了这套技术栈。
...
### AI 辅助开发
- **主模型**: Claude Code (Opus 4.6) + GLM-4.7
- **其他尝试**: Kimi、Qoder、CodeBuddy、iFly、Trae、Lingma
...
| 版本 | 时间 | 技术栈 | 结果 |
|------|------|--------|------|
| 第一版 | 2024.09 | Java 分布式 → 单体 | ❌ AI 幻觉严重，代码混乱 |
| 第二版 | 2024.10 | React + Node.js | ❌ 技术栈不熟悉，调试困难 |
| 第三版 | 2024.11 | Java + 自研前端 | ❌ 前端白屏问题无法解决 |
| 第四版 | 2024.11 - 2025.01 | Java + 外包前端 | ❌ 进度慢，接口定义混乱 |
| **第五版** | **2025.02 - 至今** | **NestJS + React** | ✅ **OpenAPI 约定，前后端同步** |
...
```
Qoder CLI → CodeBuddy → iFly CLI → Trae → Lingma
         ↓
    Claude Code + GLM-4.7 (2024.11 起)
         ↓
    Claude Code + Opus 4.6 + Codex 5.3 (2025.02)
```
