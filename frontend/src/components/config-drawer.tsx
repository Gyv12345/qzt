  ...
  return (
    <div>
      ...
      <Radio
        ...
        aria-label={t('config.theme.selectTheme')}
        aria-describedby='theme-description'
      >
        {[
          {
            value: 'system',
            label: t('config.theme.system'),
  ...
  return (
    <div className='max-md:hidden'>
      ...
      <Radio
        ...
        className='grid w-full max-w-md grid-cols-3 gap-4'
        aria-label={t('config.sidebar.selectSidebar')}
  ...
  return (
    <div className='max-md:hidden'>
      ...
      <Radio
        ...
        className='grid w-full max-w-md grid-cols-3 gap-4'
        aria-label={t('config.layout.selectLayout')}
      ...
      >
        {[
          ...
          {
            value: 'offcanvas',
            label: t('config.layout.fullLayout'),
            icon: IconLayoutFull,
          },
        ].map((item) => (
          <RadioGroupItem key={item.value} item={item} />
  ...
  return (
    <div>
      ...
      <Radio
        ...
        className='grid w-full max-w-md grid-cols-3 gap-4'
        aria-label={t('config.direction.selectDirection')}
        aria-describedby='direction-description'
      >
        {[
          {
            value: 'ltr',
            label: t('config.direction.leftToRight'),
          ...
          {
            value: 'rtl',
            label: t('config.direction.rightToLeft'),
            icon: (props: SVGProps<SVGSVGElement>) => (
