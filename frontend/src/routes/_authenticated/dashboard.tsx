  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">欢迎来到企账通客户管理系统</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="p-6 dark:bg-gray-800 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500 dark:text-gray-400">总客户数</p>
        ...
        <Card className="p-6 dark:bg-gray-800 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500 dark:text-gray-400">合同总数</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">
        ...
        <Card className="p-6 dark:bg-gray-800 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500 dark:text-gray-400">产品总数</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">
        ...
        <Card className="p-6 dark:bg-gray-800 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500 dark:text-gray-400">本月业绩</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-medium text-gray-900 dark:text-white">新建客户</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">添加新的客户信息</p>
              </div>
            </div>
          </button>
          <button
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-medium text-gray-900 dark:text-white">创建合同</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">为客户创建新合同</p>
              </div>
            </div>
          </button>
          <button
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-medium text-gray-900 dark:text-white">开票管理</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">管理开票记录</p>
              </div>
            </div>
          </button>
        </div>
      ...
      <Card className="p-6 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="space-y-4">
          {stats?.recentActivities?.length === 0 ? (
            <div className="text-center text-gray-500 dark:text-gray-400 py-8">暂无活动记录</div>
          ) : (
