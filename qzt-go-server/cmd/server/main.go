...
import (
	...
	mallmod "qzt-go-server/internal/module/mall"
...
func main() {
	...
	// 4. 组装路由（注册 15 个业务模块:system/api/cms/crm/enterprise/approval/hrm/psi/finance/oa/kb/cloud/project/marketing/mall）
